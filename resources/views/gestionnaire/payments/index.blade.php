    ...
    <div class="d-flex">
        ...
        <div class="sidebar p-3" style="width: 250px;">
            ...
            <ul class="nav flex-column">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="{{ route('payments.index') }}">Paiements</a>
                </li>
                <li class="nav-item">
                            ...
                            <tbody>
                                @foreach ($payments as $payment)
                                    <tr>
                                        ...
                                        <td>
                                            @if ($payment->order)
                                                <a href="{{ route('gestionnaire.orders.show', $payment->order_id) }}" class="btn btn-sm btn-primary">Voir Commande</a>
                                            @else
                                                <span class="text-muted">Commande introuvable</span>
                                            @endif
                                        </td>
                                    </tr>
                                @endforeach
